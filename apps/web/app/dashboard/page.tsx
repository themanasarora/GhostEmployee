...
import { LogOut, Plus, Briefcase, Zap } from "lucide-react";
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="mt-2 text-slate-400">
            Your AI workforce is ready. Create a project to get started.
          </p>
        </div>
        ...
        <div className="bg-white/[0.03] border border-white/10 rounded-2xl">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-white/5">
            ...
            <Button size="sm" disabled title="Coming in Phase 1">
          ...
          <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
            ...
            <p className="text-sm text-slate-400 max-w-xs leading-relaxed">
              A project is where you assign goals to your AI employees and
              run board meetings. Create one to hire your first team.
            </p>
